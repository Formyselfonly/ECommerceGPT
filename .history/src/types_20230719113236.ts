...
export function createSession(name: string = "NewChat",content:string="You are a helpful assistant. You can help me by answering my questions. You can also ask me questions."): Session {
    return {
        id: uuidv4(),
        name: name,
        messages: [
            ...
            {                
                id: uuidv4(),
                role: 'assistant',
                content:"I will give you an example,just Unleash your imagination!"
