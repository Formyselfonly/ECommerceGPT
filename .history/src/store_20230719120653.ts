...
export default function useStore() {
    ...
    const [chatSessions, _setChatSessions] = useState<Session[]>([createSession("YouTube","You are my Youtube ECommerce assistant ChatGPT!"),createSession("TikTok","You are my TitTok ECommerce assistant ChatGPT!"),createSession("Amazon","You are my Amazon ECommerce assistant ChatGPT!"),createSession("Shopee","You are my Shopee ECommerce assistant ChatGPT!"),createSession("DefaultGPT","Hello,I'm ChatGPT,what can i doing for u?")])
