        ...
        >
          ...
          >
            <Toolbar style={{ padding: "0 0px" }}>
              ...
              <Button href="https://www.learnprompt.org/chat-gpt-prompts-for-business/" target="_blank" style={{color:'rgb(25, 118, 210)',fontSize:'20px',marginRight:'20px'}}>Prompt For Business</Button>
