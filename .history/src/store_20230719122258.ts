...
export default function useStore() {
    ...
    createSession("YouTube","You are my Youtube ECommerce assistant ChatGPT!Preferably answer using markdown or tables","Click these short link to know how to easily use this amazing YoutubeGPT:Link to be done"),
