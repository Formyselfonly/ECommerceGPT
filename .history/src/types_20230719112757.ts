...
export function createSession(name: string = "NewChat",content:string="asdYou are a helpful assistant. You can help me by answering my questions. You can also ask me questions."): Session {
    return {
        id: uuidv4(),
        name: name,
        messages: [
