...
export default function useStore() {
    ...
    const [chatSessions, _setChatSessions] = useState<Session[]>([createSession("YouTube","You are my Youtube ECommerce assistant!"),createSession("TikTok","You are my TitTok ECommerce assistant!"),createSession("Amazon","You are my Amazon ECommerce assistant!"),createSession("Shopee","You are my Shopee ECommerce assistant!"),createSession("DefaultChat","You are my Shopee ECommerce assistant!")])
