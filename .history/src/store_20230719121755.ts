...
export default function useStore() {
    ...
    createSession("YouTube","You are my Youtube ECommerce assistant ChatGPT!Preferably answer using markdown or tables",""),
    ...
    createSession("Amazon","You are my Amazon ECommerce assistant ChatGPT!Preferably answer using markdown or tables"),
    createSession("Shopee","You are my Shopee ECommerce assistant ChatGPT!Preferably answer using markdown or tables"),
    createSession("DefaultGPT","Hello,I'm ChatGPT,what can i doing for u?Preferably answer using markdown or tables")])
