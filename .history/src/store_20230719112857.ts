...
export default function useStore() {
    ...
    const [chatSessions, _setChatSessions] = useState<Session[]>([createSession("YouTube","You are my Youtube ECommerce assistant!"),createSession("TikTok"),createSession("TikTok"),createSession("Shopee")])
